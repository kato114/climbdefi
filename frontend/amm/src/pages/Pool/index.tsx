...
import { Button, CardBody, Heading, Text } from '@pancakeswap-libs/uikit'
  ...
  return (
    <>
      <Heading
        ...
        color="primary"
        my="50px"
        style={{ fontFamily: 'LULO', fontSize: '25px', textAlign: 'center' }}
      >
        MAKE YOUR CRYPTO CLIMB
      </Heading>
        ...
        <AutoColumn gap="lg" justify="center">
          <CardBody>
            <AutoColumn gap="12px" style={{ width: '100%' }}>
              ...
              {!account ? (
                <LightCard padding="40px" style={{ background: '#1a2c38' }}>
